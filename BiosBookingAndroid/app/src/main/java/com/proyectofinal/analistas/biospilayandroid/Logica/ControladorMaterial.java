...
public class ControladorMaterial {
    ...
    public List<DTMaterial> ListarMaterialesXObra(int idObra, SQLiteDatabase db){
    ...
    public List<DTMovimiento> ListarMovimientosXMaterial(int idObra, String nombreMaterial, SQLiteDatabase db){
